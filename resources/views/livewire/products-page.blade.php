...
<img src="{{ asset($product->gambar[0] ?? '') }}" alt="{{ $product->name }}" class="object-cover w-full h-56 mx-auto ">                </div>
                <div class="p-3 ">
                  ...
                  <p class="text-lg ">
                    <span class="text-green-600 dark:text-green-600">{{ Number::currency($product->price, 'IDR')}}
                  </p>
                </div>
